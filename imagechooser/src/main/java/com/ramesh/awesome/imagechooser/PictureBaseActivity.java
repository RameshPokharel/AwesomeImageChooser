...
import com.ramesh.awesome.imagechooser.dialog.PictureDialog;
...
import com.ramesh.awesome.imagechooser.immersive.ImmersiveManage;
import com.ramesh.awesome.imagechooser.rxbus2.RxBus;
import com.ramesh.awesome.imagechooser.tools.AttrsUtils;
import com.ramesh.awesome.imagechooser.tools.DateUtils;
import com.ramesh.awesome.imagechooser.tools.DoubleUtils;
...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            if (getIntent() != null) {
                config = (ImageConfig) getIntent().getSerializableExtra(PictureConfig.EXTRA_CONFIG);
            }
    ...
    private void initConfig() {
        outputCameraPath = config.cameraPath;
        // 是否开启白色状态栏
...
*/
    ...
    protected void onResult(List<LocalMedia> images) {
        ...
        Intent intent = ImageSelector.Companion.putIntentResult(images);
