...
import com.ramesh.awesome.imagechooser.ImageConfig;
...
import com.ramesh.awesome.imagechooser.tools.ToastManage;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PictureImageGridAdapter(Context context, ImageConfig config) {
        this.context = context;
        this.config = config;
        this.selectMode = config.selectionMode;
        this.showCamera = config.isCamera;
        this.maxSelectNum = config.max;
        this.enablePreview = config.isPreview;
